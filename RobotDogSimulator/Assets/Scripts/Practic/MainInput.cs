...
//     version 1.14.0
//     from Assets/Scripts/Practic/MainInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Practic/MainInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @MainInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Mouse"",
            ""id"": ""43162239-6114-41a3-be3c-769e81891621"",
            ""actions"": [
                {
                    ""name"": ""Position"",
                    ""type"": ""Value"",
                    ""id"": ""d10a4da3-7453-4e20-81e4-5b41fec22b18"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""3c0500bf-47c0-4131-bb30-b7d83fbf5e0a"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@MainInput()
    {
        UnityEngine.Debug.Assert(!m_Mouse.enabled, "This will cause a leak and performance issues, MainInput.Mouse.Disable() has not been called.");
    }
